...
void generation::BuildRoom(Room& room, RoomModels* rm, s_ptr<Shader> shader, RoomLayoutGenerator* rlg, s_ptr<tmp::Texture> particle_texture, s_ptr<Shader> particle_shader)
{
    ...
    case 1:
    {
        ...
        for (int i = 0; i < room.enemies_positions.size(); i++)
        {
            ...
            enemy_mesh->GetComponent<components::Animator>()->AddAnimation("Idle_1", enemy_death_1);
            enemy_mesh->GetComponent<components::Animator>()->AddAnimation("Idle_2", enemy_death_2);
            enemy_mesh->GetComponent<components::Animator>()->AddAnimation("Idle_3", enemy_death_3);
            enemy_mesh->GetComponent<components::Animator>()->AddAnimation("Idle_4", enemy_death_4);
            enemy_mesh->GetComponent<components::Animator>()->AddAnimation("Idle_5", enemy_death_5);
