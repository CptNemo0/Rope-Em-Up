...
public:
	...
	s_ptr<Shader> pointlight_depth_shader_;
	...
	ShadowsManager(s_ptr<Shader> PointLightDepthShader, s_ptr<Shader> depthShader);
	~ShadowsManager() = default;
	static void Initialize(s_ptr<Shader> PointLightDepthShader, s_ptr<Shader> depthShader);
